      ...
      >
        ...
        <div className="relative z-10 text-neutral-content text-left p-14 flex justify-left items-center top-20">
          <div className="max-w-md">
            <h1 className=" text-5xl font-bold">Get Your
<p className='my-4'>First Appointment</p>
<p>at 50% Off!</p></h1>
          
<div className='flex gap-4 mt-8'>
<button className=' px-5 py-3 rounded-lg bg-[#FFC637] flex items-center'><span className='mr-2 font-semibold text-black'>Appointment</span> <img src={arrow2} className='w-3 h-3' alt="" /></button>
