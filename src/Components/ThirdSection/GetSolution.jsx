...
const GetSolution = () => {
  return (
    <div className='flex flex-col lg:flex-row mx-20 justify-between'>
     <div className='w-1/2 '>
     <button className='outline outline-1 px-5 py-2 rounded-full'>Who we are</button>
...
'><span className='mr-2 font-semibold'>Learn more</span> <img src={arrow} className='w-3 h-3' alt="" /></button>
     ...
     <div className=' relative'>
        <img src={img1} alt="" />
        <div className='bg-[#343268] text-white rounded-badge py-10 px-8 absolute top-60 -left-20 right-60 '>
